...
/**
 * Facade backing the board page with derived state and actions.
 */
@Injectable()
export class BoardPageStore {
  private readonly workspace = inject(WorkspaceStore);

  public readonly subtaskStatusOptions = SUBTASK_STATUS_META;

  /** Reload workspace aggregation to keep the board current. */
  public refreshWorkspaceData(): Promise<void> {
    return this.workspace.refreshWorkspaceData();
  }
  ...
  public readonly columnAccent = (column: ColumnAccentSource): string =>
