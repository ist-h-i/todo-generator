...
import {
  ...
  UserProfile,
} from '@features/shell/models/profile.models';
import { Profile } from '@features/shell/data/profile';
...
export class ProfileDialog implements AfterViewInit {
