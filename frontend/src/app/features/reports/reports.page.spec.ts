...
import { ReportAssistantPage } from './reports.page';
...
describe('ReportAssistantPage', () => {
  let fixture: ComponentFixture<ReportAssistantPage>;
  let component: ReportAssistantPage;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ReportAssistantPage, RouterTestingModule],
      providers: [
    ...
    fixture = TestBed.createComponent(ReportAssistantPage);
