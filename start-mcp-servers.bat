...
rem Force UTF-8 for Python-based MCP servers to avoid build-time decode errors on Windows.
set "PYTHONUTF8=1"
...
call :start_uvx "MCP Serena Server" "--python 3.11 --from git+https://github.com/oraios/serena serena start-mcp-server --context codex --project ""%PROJECT_DIR%"""
