...
- **Persistence & background models** – Cards, analytics, Why-Why analyses, suggested actions, status reports, and appeal content are stored in relational models with JSON columns.【F:backend/app/models.py†L120-L780】
...
- `docs/features/status-reporting/requirements.md` – Requirements for status reporting and AI analysis.
- `docs/features/status-reporting/detail-design.md` – Detailed design for status reporting services and UI workflow.
...
- `docs/features/ai-intake-status-reports/requirements.md` – Requirements for AI intake analyzer and status report workflows.
